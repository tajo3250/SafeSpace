    ...
    return (
        <footer className="shrink-0 bg-transparent pb-[calc(env(safe-area-inset-bottom,0px)+4px)] pt-3 px-4 md:px-6">
            ...
            >
                ...
                <div className="flex gap-2 md:gap-3 items-end relative bg-white/5 p-2 md:p-3 rounded-2xl border border-white/10 shadow-[0_18px_60px_-45px_rgba(0,0,0,0.9)] ring-1 ring-white/5 transition-all focus-within:ring-[rgb(var(--ss-accent-rgb)/0.5)] focus-within:border-[rgb(var(--ss-accent-rgb)/0.35)] focus-within:bg-white/10">
                    <input
                        ref={fileInputRef}
                        type="file"
                        multiple
                    ...
                    <button
                        ...
                        disabled={attachmentsDisabled}
                        className={[
                            "hidden sm:flex h-11 w-11 rounded-xl border border-white/10 items-center justify-center transition-colors text-xs font-semibold tracking-wide",
                            attachmentsDisabled
                                ? "bg-white/5 text-slate-500 cursor-not-allowed"
                                : "bg-white/10 hover:bg-white/16 text-slate-200"
                        ].join(" ")}
                    ...
                    <button
                        ...
                        className="hidden sm:flex h-11 w-11 rounded-xl border border-white/10 bg-white/10 hover:bg-white/16 items-center justify-center transition-colors text-slate-200"
                        title="Add emoji"
